...
public enum UsageStatisticsGroupPosition implements PositionAware {
  ...
  VCS_ROOT_TYPES(after(SERVER_LOAD, RUNNERS, BUILD_FEATURES, BUILD_FAILURE_CONDITIONS, IDE_PLUGINS, WEB_BROWSERS)),
  TRIGGERS(after(SERVER_LOAD, RUNNERS, BUILD_FEATURES, BUILD_FAILURE_CONDITIONS, IDE_PLUGINS, WEB_BROWSERS, VCS_ROOT_TYPES)),
  NOTIFIERS(after(SERVER_LOAD, RUNNERS, BUILD_FEATURES, BUILD_FAILURE_CONDITIONS, IDE_PLUGINS, WEB_BROWSERS, VCS_ROOT_TYPES, TRIGGERS)),
  ISSUE_TRACKERS(after(SERVER_LOAD, RUNNERS, BUILD_FEATURES, BUILD_FAILURE_CONDITIONS, IDE_PLUGINS, WEB_BROWSERS, VCS_ROOT_TYPES, TRIGGERS, NOTIFIERS)),
  INVESTIGATION_MUTE(after(SERVER_LOAD, RUNNERS, BUILD_FEATURES, BUILD_FAILURE_CONDITIONS, IDE_PLUGINS, WEB_BROWSERS, VCS_ROOT_TYPES, TRIGGERS, NOTIFIERS, ISSUE_TRACKERS)),
