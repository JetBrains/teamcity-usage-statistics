...
public class BaseSimpleUsageStatisticsGroup implements UsageStatisticsGroupExtension {
  @NotNull private final String myJspPagePath;
  @NotNull private List<UsageStatisticPresentation> myStatistics;

  protected BaseSimpleUsageStatisticsGroup(@NotNull final PluginDescriptor pluginDescriptor, @NotNull final String jspPageRelativePath) {
