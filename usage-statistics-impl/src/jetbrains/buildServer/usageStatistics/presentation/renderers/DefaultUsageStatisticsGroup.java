...
public class DefaultUsageStatisticsGroup implements UsageStatisticsGroupExtension {
  ...
  public DefaultUsageStatisticsGroup(@NotNull final PluginDescriptor pluginDescriptor) {
    myJspPagePath = pluginDescriptor.getPluginResourcesPath("renderers/default.jsp");
  }
