...
public class BuildFailureConditionUsageStatisticsProvider extends BaseBuildTypeBasedExtensionUsageStatisticsProvider<SBuildFeatureDescriptor> {
  public BuildFailureConditionUsageStatisticsProvider(@NotNull final SBuildServer server) {
    super(server);
  }
  ...
  protected PositionAware getGroupPosition() {
    return UsageStatisticsGroupPosition.BUILD_FAILURE_CONDITIONS;
  }
  ...
  protected Collection<SBuildFeatureDescriptor> collectExtensions(@NotNull final SBuildType buildType) {
    return FilterUtil.filterAndCopy(buildType.getBuildFeatures(), new ArrayList<SBuildFeatureDescriptor>(), new Filter<SBuildFeatureDescriptor>() {
      public boolean accept(@NotNull final SBuildFeatureDescriptor featureDescriptor) {
        return featureDescriptor.getBuildFeature().getPlaceToShow() == BuildFeature.PlaceToShow.FAILURE_REASON;
      }
    });
  }
