...
<c:if test="${empty param['updateMessages']}">
  <c:if test="${editAllowed}">
    <div>
      ...
      <div style="margin-bottom: 1em">You can view what data is collected before sending it. Note that this operation might take up to several minutes. The task will be performed in the background, so you can safely close this page.</div>
